...
\begin{itemize}
	...
	%Now suppose that $|G|$ is not invertible in $R$. Under the above identification, $|G|\Sigma_{\sigma \in G}\sigma = \left(\Sigma_{\sigma \in G}\sigma\right)^2$ (calculation from tutorials) is not invertible in $RG$. However, this leads to a contradiction, since $\Sigma_{\sigma \in G}\sigma$ is a unit under identification.
